...
void BN12_print_parameters(){
    ...
    printf("====================================================================================\n");
    printf("BN12 Class 1 (HW=4)\n\n");
    gmp_printf("Parameters\n");
    
    gmp_printf("X = 2^{114}+2^{101}-2^{14}-1\n");
    gmp_printf("Proposed by Barbulescu at el. \"Updating key size estimations for pairings.\" (2017).\n");
    ...
    gmp_printf("BN curve\n");
    gmp_printf("E:y^2=x^3+32\n\n");
    
    gmp_printf("Twisted curve\n");
    gmp_printf("E':y^2=x^3+32(alpha+1)\n\n");
...
void test_Frobenius_map(){
    ...
    printf("frobenius\n");
    Fp12_frobenius_map_p3(&test1,&tmp_Fp12);
    Fp12_printf(&test1,"");
    printf("\n\n");
...
void test_skew_frobenius_map(){
    ...
    Fp12_frobenius_map_p1(&test1.x,&Q.x);
    Fp12_frobenius_map_p1(&test1.y,&Q.y);
    EFp12_printf(&test1,"");
    printf("\n\n");
    
    EFp2_skew_frobenius_map_p1(&twisted_Q,&twisted_Q);
